...
public class HomePageLocators {
    ...
    public static final String BUTTON_CART = "//a[@title=\"Корзина\"]";
    public static final String LINK_TEXT_HEADPHONE = "Наушники и гарнитуры";
    public static final String LINK_PARTIAL_TEXT_HEADPHONE = "Наушники";
}
